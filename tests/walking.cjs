...
(async () => {
  ...
  try {
    ...
    await page.mouse.up();
    await page.waitForFunction(() => document.getElementById('fractal-hatching').fractalDemo.getHeld().walkPose.yaw > .2);
    ...
    await page.mouse.down();
    await page.waitForFunction(z => document.getElementById('fractal-hatching').fractalDemo.getHeld().walkPose.eye[2] > z + .03, looked.walkPose.eye[2]);
    await page.mouse.up();
    ...
    await page.waitForFunction(() => document.getElementById('fractal-hatching').fractalDemo.getHeld().scene === 3);
    ...
    await page.waitForFunction(() => document.getElementById('fractal-hatching').fractalDemo.getHeld().scene === 5);
    assert.deepEqual((await state()).walkPose, initial.walkPose);
